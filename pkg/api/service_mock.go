...
func (_m *MockService) GenerateToken(ctx context.Context, keyID string, ttl time.Duration) (*token.Token, error) {
...
func (_c *MockService_GenerateToken_Call) RunAndReturn(run func(context.Context, string, time.Duration) (*token.Token, error)) *MockService_GenerateToken_Call {
	_c.Call.Return(run)
	return _c
}
