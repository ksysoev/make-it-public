...
func (_m *MockRequest) SendConn(ctx context.Context, _a1 WithWriteCloser) {
	_m.Called(ctx, _a1)
}
...
func (_c *MockRequest_SendConn_Call) Run(run func(ctx context.Context, _a1 WithWriteCloser)) *MockRequest_SendConn_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(WithWriteCloser))
	})
	return _c
}
...
func (_c *MockRequest_SendConn_Call) RunAndReturn(run func(context.Context, WithWriteCloser)) *MockRequest_SendConn_Call {
	_c.Run(run)
	return _c
}

// WaitConn provides a mock function with given fields: ctx
func (_m *MockRequest) WaitConn(ctx context.Context) (WithWriteCloser, error) {
	ret := _m.Called(ctx)
	...
	var r0 WithWriteCloser
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (WithWriteCloser, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) WithWriteCloser); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(WithWriteCloser)
		}
	}
...
func (_c *MockRequest_WaitConn_Call) Return(_a0 WithWriteCloser, _a1 error) *MockRequest_WaitConn_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRequest_WaitConn_Call) RunAndReturn(run func(context.Context) (WithWriteCloser, error)) *MockRequest_WaitConn_Call {
	_c.Call.Return(run)
	return _c
}
