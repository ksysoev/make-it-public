...
func (_m *MockServConn) RequestConnection() (conn.Request, error) {
	ret := _m.Called()
...
func (_c *MockServConn_RequestConnection_Call) Return(_a0 conn.Request, _a1 error) *MockServConn_RequestConnection_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockServConn_RequestConnection_Call) RunAndReturn(run func() (conn.Request, error)) *MockServConn_RequestConnection_Call {
	_c.Call.Return(run)
	return _c
}
