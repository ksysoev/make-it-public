...
func (_m *MockServConn) RequestConnection() (ConnReq, error) {
	ret := _m.Called()
	...
	var r0 ConnReq
	var r1 error
	if rf, ok := ret.Get(0).(func() (ConnReq, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() ConnReq); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ConnReq)
		}
	}
...
func (_c *MockServConn_RequestConnection_Call) Return(_a0 ConnReq, _a1 error) *MockServConn_RequestConnection_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockServConn_RequestConnection_Call) RunAndReturn(run func() (ConnReq, error)) *MockServConn_RequestConnection_Call {
	_c.Call.Return(run)
	return _c
}
